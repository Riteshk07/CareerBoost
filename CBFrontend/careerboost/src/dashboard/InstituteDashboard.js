...
import InstituteSideNavbar from './componants/InstituteSideNavbar';
...
import JobApplicants from './componants/JobApplicants';


const InstituteDashboard = ({ loggedIn, setLoggedIn, userDetails, usrId }) => {
    ...
    switch (section) {
        ...
        case 'home':
            ...
            break;
        case 'jobapplicants':
            contentComponent = <JobApplicants />;
            break;
        case 'newjobs':
                    ...
                    <div className="top">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn">
                                ...
                                <div style={{fontWeight:"bold"}}>Institutions</div>
                            </button>
